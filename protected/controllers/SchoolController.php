...
class SchoolController extends BaseManageController {
    public function secondLevelNavigationType() {
        return NavigationType::MANAGE_SCHOOLS;
    }
    
    public function actionAutocomplete($term){
        $schools = School::model()->Autocomplete($term);
        $result = array();
        foreach($schools as $school) {
            $result[] = array('id'=>$school->ID, 'label'=>$school->Name);
        }
    ...
    public function actionEdit() { 
        ...
        $model = $schoolId ? $this->loadModel($schoolId) : new School();
     ...
     */
     ...
     public function actionDelete() {
        ...
        if(Yii::app()->request->isPostRequest) {
            $this->loadModel($schoolId)->delete();
